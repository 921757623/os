...
int sem_new(int origin_value)
{
  return do_user_call(SYS_user_new, origin_value, 0, 0, 0, 0, 0, 0);
}

void sem_P(int sem)
{
  do_user_call(SYS_user_P, sem, 0, 0, 0, 0, 0, 0);
}

void sem_V(int sem)
{
  do_user_call(SYS_user_V, sem, 0, 0, 0, 0, 0, 0);
}